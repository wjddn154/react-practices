...
export default function Form() {
    ...
    return (
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <fieldset>
                <legend>약관동의</legend>
                <input id="agree-prov" type="checkbox" name="agreeProv" value= { agreeProv } chekced={agreeProv === 'yes'} onChange={onChangeInputProv} defaultChecked={ false } />
